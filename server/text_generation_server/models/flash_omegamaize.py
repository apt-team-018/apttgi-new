...
@dataclass
class FlashOmegaMaizeBatch(FlashCausalLMBatch):
...
class BaseFlashOmegaMaize(FlashCausalLM):
    def __init__(
        self,
        model_cls,
        model_id: str,
        ...
        if torch.cuda.is_available():
            ...
            raise NotImplementedError("FlashOmegaMaize is only available on GPU")
    ...
    @property
    def batch_type(self) -> Type[FlashOmegaMaizeBatch]:
        return FlashOmegaMaizeBatch
    ...
    def forward(
        self, batch: FlashOmegaMaizeBatch
...
class FlashOmegaMaize(BaseFlashOmegaMaize):
    def __init__(
        self,
        model_id: str,
        revision: Optional[str] = None,
        ...
        super(FlashOmegaMaize, self).__init__(
            config_cls=OmegaMaizeConfig,
            model_cls=FlashOmegaMaizeForCausalLM,
            model_id=model_id,
            revision=revision,
            quantize=quantize,
